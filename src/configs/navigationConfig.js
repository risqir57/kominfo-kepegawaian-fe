...
export const navigationConfigKominfo = [
	{
		type: 'groupHeader',
		groupTitle: 'Kominfo',
	},
		...
		children: [
			{
				...
				icon: <Icon.Circle size={12} />,
				permissions: ['admin', 'editor'],
				navLink: '/kominfo/employments/pns',
			},
			{
				id: 'employmentPpnpn',
				title: 'PPNPN',
				...
				icon: <Icon.Circle size={12} />,
				permissions: ['admin', 'editor'],
				navLink: '/kominfo/employments/ppnpn',
			},
			{
				id: 'employmentReports',
				title: 'Report',
				type: 'item',
				icon: <Icon.Circle size={12} />,
				permissions: ['admin', 'editor'],
				navLink: '/kominfo/employments/reports',
			},
		],
	},
	{
		id: 'employmentStatistics',
		title: 'Statistik Pegawai',
		type: 'item',
		icon: <Icon.BarChart size={20} />,
		permissions: ['admin', 'editor'],
		navLink: '/kominfo/employments/statistics',
	},
	{
		id: 'mailArchive',
		title: 'Arsip Surat',
		...
		children: [
			{
				...
				icon: <Icon.Circle size={12} />,
				permissions: ['admin', 'editor'],
				navLink: '/kominfo/mail-archive/out',
			},
			{
				id: 'mailIn',
				title: 'Surat Masuk',
				...
				icon: <Icon.Circle size={12} />,
				permissions: ['admin', 'editor'],
				navLink: '/kominfo/mail-archive/in',
			},
			{
				id: 'mailTodo',
				title: 'Surat Tugas',
				...
				icon: <Icon.Circle size={12} />,
				permissions: ['admin', 'editor'],
				navLink: '/kominfo/mail-archive/todo',
			},
		],
	},
	{
		id: 'organizations',
		title: 'Organisasi & Tatalaksana',
		type: 'collapse',
		...
		children: [
			...
			},
			{
				...
				icon: <Icon.Circle size={12} />,
				permissions: ['admin', 'editor'],
				navLink: '/kominfo/organizations/governances',
			},
			{
				id: 'skp',
				title: 'SKP',
				...
				icon: <Icon.Circle size={12} />,
				permissions: ['admin', 'editor'],
				navLink: '/kominfo/organizations/skp',
			},
			{
				id: 'wealthReports',
				...
				icon: <Icon.Circle size={12} />,
				permissions: ['admin', 'editor'],
				navLink: '/kominfo/organizations/wealth-reports',
			},
		],
	},
	{
		id: 'formationMutation',
		title: 'Formasi & Mutasi',
		type: 'collapse',
		icon: <Icon.ThumbsUp size={20} />,
		children: [
			{
				id: 'formationsEmployment',
				title: 'Formasi Pegawai',
				type: 'item',
				icon: <Icon.Circle size={12} />,
				permissions: ['admin', 'editor'],
				navLink: '/kominfo/formation-mutation/formation-employments',
			},
			{
				id: 'mutationEmployment',
				title: 'Mutasi Pegawai',
				type: 'item',
				icon: <Icon.Circle size={12} />,
				permissions: ['admin', 'editor'],
				navLink: '/kominfo/formation-mutation/mutation-employments',
			},
			{
				id: 'promotion',
				...
				icon: <Icon.Circle size={12} />,
				permissions: ['admin', 'editor'],
				navLink: '/kominfo/formation-mutation/promotions',
			},
			{
				id: 'promotionRank',
				...
				icon: <Icon.Circle size={12} />,
				permissions: ['admin', 'editor'],
				navLink: '/kominfo/formation-mutation/promotion-rank',
			},
			{
				id: 'appreciationEmployment',
				title: 'Penghargaan Pegawai',
				type: 'item',
				icon: <Icon.Circle size={12} />,
				permissions: ['admin', 'editor'],
				navLink: '/kominfo/formation-mutation/appreciation-employment',
			},
			{
				id: 'periodicSalaryIncreases',
				title: 'Kenaikan Gaji Berkala',
				type: 'item',
				icon: <Icon.Circle size={12} />,
				permissions: ['admin', 'editor'],
				navLink: '/kominfo/formation-mutation/periodic-salary-increases',
			},
			{
				id: 'pension',
				title: 'Pensiun',
				...
				icon: <Icon.Circle size={12} />,
				permissions: ['admin', 'editor'],
				navLink: '/kominfo/formation-mutation/pension',
			},
			{
				id: 'welfareOfficers',
				...
				icon: <Icon.Circle size={12} />,
				permissions: ['admin', 'editor'],
				navLink: '/kominfo/formation-mutation/welfare-officers',
			},
		],
	},
	{
		...
		children: [
			{
				...
				icon: <Icon.Circle size={12} />,
				permissions: ['admin', 'editor'],
				navLink: '/kominfo/development/diklats',
			},
			{
				id: 'serviceExamsAdjustments',
				title: 'Ujian Dinas & Penyesuaian',
				type: 'item',
				icon: <Icon.Circle size={12} />,
				permissions: ['admin', 'editor'],
				navLink: '/kominfo/development/service-exams-adjustments',
			},
			{
				id: 'officerDiscipline',
				title: 'Disiplin Pegawai',
				type: 'item',
				icon: <Icon.Circle size={12} />,
				permissions: ['admin', 'editor'],
				navLink: '/kominfo/development/officer-discipline',
			},
			{
				id: 'departmentalEvaluation',
				title: 'Penilaian Jabatan',
				type: 'item',
				icon: <Icon.Circle size={12} />,
				permissions: ['admin', 'editor'],
				navLink: '/kominfo/development/departmental-evaluation',
			},
			{
				id: 'submissionIncense',
				title: 'Pengajuan Dupak',
				type: 'item',
				icon: <Icon.Circle size={12} />,
				permissions: ['admin', 'editor'],
				navLink: '/kominfo/development/submission-incense',
			},
			{
				id: 'assignmentsStudyPermits',
				title: 'Tugas & Ijin Belajar',
				type: 'item',
				icon: <Icon.Circle size={12} />,
				permissions: ['admin', 'editor'],
				navLink: '/kominfo/development/assignments-study-permits',
			},
		],
	},
	{
		...
		children: [
			{
				id: 'bureaucraticReform',
				title: 'Reformasi Birokrasi',
				type: 'item',
				icon: <Icon.Circle size={12} />,
				permissions: ['admin', 'editor'],
				navLink: '/kominfo/rb-spip/bureaucratic-reform',
			},
			{
				id: 'serviceExamsAdjustments',
				title: 'SPIP',
				...
				icon: <Icon.Circle size={12} />,
				permissions: ['admin', 'editor'],
				navLink: '/kominfo/rb-spip/spip',
			},
		],
	},
];

const mergeNavigation = [...navigationConfig, ...navigationConfigKominfo];

export default isDev ? mergeNavigation : navigationConfigKominfo;
