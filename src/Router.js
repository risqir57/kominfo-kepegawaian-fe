...
// Kominfo screen
const kominfoDashboard = lazy(() => import('./views/kominfo/dashboard/Dashboard'));
const kominfoUsers = lazy(() => import('./views/kominfo/user/list/List'));
...
const kominfoEmploymentPpnpnView = lazy(() =>
	import('./views/kominfo/employments/ppnpn/view/View')
);
const kominfoEmploymentPpnpnEdit = lazy(() =>
	import('./views/kominfo/employments/ppnpn/edit/Edit')
);
const kominfoEmploymentReportList = lazy(() =>
	import('./views/kominfo/employments/report/list/List')
);
	...
	render() {
		return (
			...
			<Router history={history}>
				<Switch>
					{/* TODO: Kominfo route start */}
					<AppRoute exact path="/kominfo" component={kominfoDashboard} />
					<AppRoute exact path="/kominfo/users" component={kominfoUsers} />
					<AppRoute exact path="/kominfo/users/:id" component={kominfoUserView} />
					<AppRoute exact path="/kominfo/users/:id/edit" component={kominfoUserEdit} />
					<AppRoute exact path="/kominfo/employments/pns" component={kominfoEmploymentPns} />
					<AppRoute
						exact
						path="/kominfo/employments/pns/:id"
					...
					/>
					<AppRoute exact path="/kominfo/employments/ppnpn" component={kominfoEmploymentPpnpn} />
					<AppRoute
						exact
					...
					<AppRoute
						exact
						path="/kominfo/employments/ppnpn/:id/edit"
						component={kominfoEmploymentPpnpnEdit}
					/>
					<AppRoute
						exact
						path="/kominfo/employments/reports"
						component={kominfoEmploymentReportList}
					/>
					{/* TODO: Kominfo route stop */}
					<AppRoute exact path="/" component={() => <Redirect to="/kominfo" />} />
