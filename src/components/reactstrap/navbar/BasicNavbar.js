											...
											<div className="navbar-collapse" id="navbar-mobile">
												<div className="mr-auto float-left bookmark-wrapper d-flex align-items-center">
													...
													<ul className="nav navbar-nav bookmark-icons">
														<NavItem className="nav-item d-none d-lg-block">
															...
															<UncontrolledTooltip placement="bottom" target="appTodoNav">
																Todo
															</UncontrolledTooltip>
														</NavItem>
														<NavItem className="nav-item d-none d-lg-block">
															...
															<UncontrolledTooltip placement="bottom" target="appChatNav">
																Chat
															</UncontrolledTooltip>
														</NavItem>
														<NavItem className="nav-item d-none d-lg-block">
															...
															<UncontrolledTooltip placement="bottom" target="appMailNav">
																Mail
															</UncontrolledTooltip>
														</NavItem>
														<NavItem className="nav-item d-none d-lg-block">
															...
															<UncontrolledTooltip placement="bottom" target="appCalendarNav">
																Calendar
															</UncontrolledTooltip>
														</NavItem>
														<NavItem className="nav-item d-none d-lg-block">
												...
												<ul className="nav navbar-nav float-right">
													<UncontrolledDropdown tag="li" className="dropdown-language nav-item">
														<DropdownToggle tag="a" data-toggle="dropdown" className="nav-link">
													...
													<NavItem className="nav-search">
														<NavLink className="nav-link-search">
															<Search size={21} id="UncontrolledTooltipExample" />
														</NavLink>
													</NavItem>
														...
														<DropdownMenu tag="ul" right className="dropdown-menu-media">
															...
															<PerfectScrollbar
																...
																<div className="d-flex justify-content-between">
																	<Media className="d-flex align-items-start">
																		<Media left href="#">
																			<DownloadCloud className="font-medium-5 success" size={21} />
																		</Media>
																		<Media body>
																...
																<div className="d-flex justify-content-between">
																	<Media className="d-flex align-items-start">
																		<Media left href="#">
																			<AlertTriangle className="font-medium-5 danger" size={21} />
																		</Media>
																		<Media body>
																...
																<div className="d-flex justify-content-between">
																	<Media className="d-flex align-items-start">
																		<Media left href="#">
																			<CheckCircle className="font-medium-5 info" size={21} />
																		</Media>
																		<Media body>
													...
													<UncontrolledDropdown tag="li" className="dropdown-user nav-item">
														...
														<DropdownMenu right>
															<DropdownItem tag="a" href="#">
																...
																<span className="align-bottom">Edit Profile</span>
															</DropdownItem>
															<DropdownItem tag="a" href="#">
