...
class UsersList extends React.Component {
				...
				cellRendererFramework: params => {
					return (
						<div
							...
							onClick={() => history.push(`/kominfo/users/${params.data.id}`)}>
							<img
					...
					return (
						<div className="actions cursor-pointer">
							...
							<Edit
								className="mr-50"
								size={15}
								onClick={() => history.push(`/kominfo/users/${params.data.id}/edit`)}
							/>
							<Trash2
								size={15}
								onClick={() => {
	...
	render() {
		...
		return (
			<Fragment>
				<BreadCrumbs breadCrumbTitle="User" breadCrumbParent="User" breadCrumbActive="List" />
									...
									<div className="ag-grid-actions d-flex justify-content-between flex-wrap mb-1">
										...
										<div className="filter-actions d-flex">
											...
											<div>
												<Button.Ripple
													color="primary"
													onClick={() => history.push('/kominfo/users/1/edit')}>
													Add
												</Button.Ripple>
											</div>
										</div>
