				...
				<Row className="mt-1">
					<Col className="mt-1" md="6" sm="12">
						...
						<FormGroup>
							...
							<div className="d-inline-block mr-1">
								<Radio label="Male" color="primary" defaultChecked={false} name="gender" />
							</div>
							<div className="d-inline-block mr-1">
								<Radio label="Female" color="primary" defaultChecked={true} name="gender" />
							</div>
							<div className="d-inline-block">
								<Radio label="Others" color="primary" defaultChecked={false} name="gender" />
							</div>
						</FormGroup>
						<FormGroup>
					...
					<Col className="mt-1" md="6" sm="12">
						...
						<FormGroup>
							...
							<Input type="text" defaultValue="Camden Town" id="city" placeholder="City" />
						</FormGroup>
						<FormGroup>
							<Label for="State">State</Label>
							<Input type="text" defaultValue="London" id="State" placeholder="State" />
						</FormGroup>
						<FormGroup>
							<Label for="Country">Country</Label>
							<Input type="text" defaultValue="UK" id="Country" placeholder="Country" />
						</FormGroup>
					</Col>
